  ...
  return (
    <div id="projects">
      ...
      <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-3 mt-6 mb-6">
        <Link href="https://github.com/arnabpal2022/chat-room">
          <Card
            name="chat-room"
        ...
        <Link href="https://github.com/arnabpal2022/CaptiGen">
          <Card
            name="CaptiGen"
        ...
        <Link href="https://github.com/Sreyasree-001/Pokedex">
          <Card
            name="PokeDex"
        ...
        <Link href="https://github.com/arnabpal2022/toDoList">
          <Card
            name="toDoList"
      ...
      <div className="text-right font-bold text-xl mb-2">
        <Link href="https://github.com/arnabpal2022">
          <p className="hover-underline-animation">More Projects in Here ⮩</p>
        </Link>
      </div>
    </div>
  );
